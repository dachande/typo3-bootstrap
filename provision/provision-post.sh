...
echo -e "==================================================================================================="
echo -e " "
echo -e " If you have the vagrant-hostsupdater plugin installed or if you have already updated your hosts"
...
echo -e " "
echo -e " Username: ${t3bs_typo3_admin_user}"
echo -e " Password: ${t3bs_typo3_admin_pass}"
echo -e " "
