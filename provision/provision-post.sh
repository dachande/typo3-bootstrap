...
echo -e " "
echo -e " Frontend: ${PROTO}://${t3bs_hostname}"
echo -e " Backend:  ${PROTO}://${t3bs_hostname}/typo3"
echo -e " MailHog:  ${PROTO}://${t3bs_hostname}:8025"
echo -e " "
...
echo -e " Backend:  ${PROTO}://${t3bs_ip}/typo3"
echo -e " MailHog:  ${PROTO}://${t3bs_ip}:8025"
echo -e " "
